...
class e1arithmetic {
	...
	public static void main(String[] args) {
		...
		theOperator = args[2].charAt(0); // consider only the first character
		// i.e. in the string argument args[2], we take the first character.
		...
		switch(theOperator) {
			...
			case ('/'): System.out.println(operand1 / operand2);
						break;
			default: System.out.printf("%nError: Invalid operator.");
			// %n is a line break.
		}
	}

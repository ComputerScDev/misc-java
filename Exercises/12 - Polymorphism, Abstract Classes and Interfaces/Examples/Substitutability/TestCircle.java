...
public class TestCircle {
	...
	public static void main(String[] args) {
		...
		//	compilation errors since c1 is a reference to a Circle class object, however it's using a Cylinder subclass instance as a reference
		System.out.println(c1.getArea());	// here we run the overriden version 
		//	in general: instantiated objects obey overriden methods of subclasses despite acting as superclass references
	}
}

...
public class LuckySevens {
	...
	// member fields (variables) : everything we want to know abt a game
	...
	private int nRolls;						// number of rolls in the game until bankrupt
	...
	// basic setters
	public void setWinValue(int n) {
		this.winValue = n; 
	}
	public void setLoseValue(int n) {
		this.loseValue = n;
	}
	...
	public void setMaxCash(int n) {
		this.maxCash = n;
	}
	public void setRollFreq(int i, int n) {
		this.rollFreq[i] = n;
	}
	public void suppressOutput(boolean b) {
		this.doSuppressOutput = b;
	}
	...
	public void printHistogram() {
		int maxHeight = 10;
		double maxVal = (double)arrayMax(this.rollFreq);
